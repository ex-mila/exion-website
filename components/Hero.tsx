      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full pt-20 pb-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[calc(100vh-5rem)]">
          ...
          <div className="flex flex-col justify-center">
            ...
            {/* Headline */}
            <h1
              className={`${isKo ? 'text-2xl md:text-3xl lg:text-4xl' : 'text-3xl md:text-4xl lg:text-5xl'} xl:text-5xl font-bold text-[#111827] leading-[1.15] tracking-tight mb-5 whitespace-pre-line`}
            >
              {t.headline}
            </h1>
            ...
            {/* Mobile image */}
            <div className="flex items-center justify-center -mt-6 mb-4 lg:hidden">
              <Image
                src="/images/EXION-DX.jpg"
                alt="EXION"
                width={600}
                height={600}
                className="w-[100%] max-w-[460px] h-auto object-contain"
                priority
                quality={90}
              />
            </div>
            ...
            {/* Stats */}
            <div className="grid grid-cols-3 gap-3 sm:flex sm:items-start sm:gap-8 pt-8 border-t border-[#111827]/08">
              {t.stats.map((stat, i) => (
                <div key={i} className="sm:flex-1 min-w-0">
                  <div className="text-base sm:text-xl font-bold text-[#111827] tabular-nums">
                    {stat.value}
                  </div>
                  <div className="text-xs text-[#111827]/40 mt-0.5 sm:whitespace-pre-line">
                    {stat.label}
                  </div>
                </div>
              ))}
          ...
          <div className="hidden lg:flex items-center justify-end">
            <Image
              ...
              width={600}
              height={600}
              className="mt-22 w-full max-w-[480px] lg:max-w-[580px] h-auto object-contain"
              priority
              quality={90}
            />
          </div>
